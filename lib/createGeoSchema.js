...
const createGeoSchema = (typeName) => {
  ...
  if (dsc.coordinates.type === undefined) {
    throw new Error(format('createGeoSchema(%o): bad type!', typeName))
  }
...
exports = module.exports = createGeoSchema

exports.validTypes = Reflect.ownKeys(types)
